...
describe("berlinClockLine1 function should return the 5-hours line of the Berlin Clock", function(){ 
    ...
    it("berlinClockLine1 should return R--- when given time with hours = 6", function() {
        const date = new Date();
        date.setHours(6);
    ...
    it("berlinClockLine1 should return R--- when given time with hours = 7", function() {
        const date = new Date();
        date.setHours(7);
    ...
    it("berlinClockLine1 should return RR-- when given time with hours = 10", function() {
        const date = new Date();
        date.setHours(10);
    ...
    it("berlinClockLine1 should return RR-- when given time with hours = 11", function() {
        const date = new Date();
        date.setHours(11);
    ...
    it("berlinClockLine1 should return RRR- when given time with hours = 15", function() {
        const date = new Date();
        date.setHours(15);
    ...
    it("berlinClockLine1 should return RRRR when given time with hours = 20", function() {
        const date = new Date();
        date.setHours(20);
    ...
    it("berlinClockLine1 should return RRRR when given time with hours = 21", function() {
        const date = new Date();
        date.setHours(21);
...
describe("secondsButton function should return the seconds button of the Berlin Clock", function(){ 
    ...
    it("secondsButton should return - when given time with seconds = 1", function() {
        const date = new Date();
        date.setSeconds(1);
    ...
    it("secondsButton should return - when given time with seconds = 3", function() {
        const date = new Date();
        date.setSeconds(3);
    ...
    it("secondsButton should return - when given time with seconds = 5", function() {
        const date = new Date();
        date.setSeconds(5);
